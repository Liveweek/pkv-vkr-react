...
import { Heading, Box, IconButton, Flex, Center, Table, Thead, Tr, Th, Td, Tbody, Spacer, Text, FormControl, FormLabel, Input, Button} from '@chakra-ui/react';
...
function App() {
  ...
  return (
    <Box className="App" mb='40px'>
      <Header moduleName={"Товары магазина"}/>

      <Box mx="80px" mt="25px" alignItems="center">
        <Flex>
          <Center>
            <Heading as='h2' color="blue.800">Название товара</Heading>
            <IconButton 
